...
<div class="row" id="content_row">
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
		...
		<form name="frm1" id="frm1" action="<%=request.getContextPath() %>/DirectUpdateCustomCtrl" method="post">
				...
				<tbody>
					...
					<th>비밀번호</th>
						<td>
							...
							<button type="button" class="btn btn-outline-warning" onclick="defaultPass()">비밀번호 초기화</button>
			...
			<div class="btn-group">
				<input type="submit" name="submit-btn" class="btn btn-outline-warning" value="정보수정">
